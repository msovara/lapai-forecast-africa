...
**Explainability (Fig. 11):** gradient saliency on African-mean **2t** + why **+12 h** fails — [`mvula_fig11_t2m_xai_attribution.png`](figures/mvula_fig11_t2m_xai_attribution.png) · [`MVULA_XAI_ATTRIBUTION.md`](MVULA_XAI_ATTRIBUTION.md).
...
| XAI attribution / +12 h | Yes | [`MVULA_XAI_ATTRIBUTION.md`](MVULA_XAI_ATTRIBUTION.md) · [`mvula_fig11_t2m_xai_attribution.png`](figures/mvula_fig11_t2m_xai_attribution.png) |
