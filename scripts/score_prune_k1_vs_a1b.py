...
FC_DIR = ROOT / "data/processed/trackA_prune_k1/forecasts"
SCORECARD = ROOT / "reports/trackA_prune_k1_SCORECARD.json"
A1B_CARD = ROOT / "reports/TRACKA_GT_COARSEN_SCORECARD.json"
GATE_OUT = ROOT / "reports/TRACKA_A2_GATE_K1_VS_A1B.json"
...
def main() -> int:
    ...
    card = {
        "phase": "trackA_a2_prune_round1_k1",
        "status": "candidate",
