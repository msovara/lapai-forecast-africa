...
| `inference_aifs_netcdf_example.yaml` | Longer **`lead_time`** + commented **`output:`** stubs ([Saving Outputs](https://anemoi.readthedocs.io/projects/inference/en/latest/usage/advanced/saving.html)): **`netcdf:`** / **`grib:`** path-style keys (verify against your `anemoi-inference` version). |
